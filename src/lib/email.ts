...
export function magicLinkEmail(loginUrl: string): { subject: string; html: string; text: string } {
  return {
    subject: 'Sign in to Austin Rifle Club',
    html: `
      <!DOCTYPE html>
      <html>
      <head>
      ...
      <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <h2 style="color: #166534;">Sign In</h2>
        <p>Click the button below to sign in to your Austin Rifle Club account:</p>
        <div style="text-align: center; margin: 30px 0;">
          <a href="${loginUrl}" style="background-color: #166534; color: white; padding: 12px 30px; text-decoration: none; border-radius: 6px; display: inline-block; font-weight: 600;">Sign In</a>
        </div>
