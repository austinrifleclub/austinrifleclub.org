...
| [02-phase-1-core.md](./02-phase-1-core.md) | Core features (must have) |
| [03-phase-2-enhanced.md](./03-phase-2-enhanced.md) | Enhanced features (should have) |
| [04-phase-3-community.md](./04-phase-3-community.md) | Community & advanced features (nice to have) |
...
1. **Phase 1** — Launch-critical features for basic club operations
2. **Phase 2** — Features that significantly improve member experience
3. **Phase 3** — Community building and engagement features
